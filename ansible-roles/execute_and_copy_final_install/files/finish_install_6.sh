...
chmod --recursive 775 /home/shared/
...
if setcap cap_net_raw+p /bin/ping
then
...
if [ -d "/opt/rh/httpd24/root/var/www/html" ]
then
    rm --recursive --force /opt/rh/httpd24/root/var/www/html
    ln --symbolic /var/www/html /opt/rh/httpd24/root/var/www/html
fi
